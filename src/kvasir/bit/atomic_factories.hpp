...
namespace bit{
	...
	template<typename T>
	constexpr std::enable_if<detail::is_write_literal<T>::value> atomic(T){

	}
	template<typename T>
	constexpr std::enable_if<detail::is_write_runtime<T>::value> atomic(T in){

	}
	template<typename T, typename U, typename...Ts>
	constexpr std::enable_if<detail::is_write_literal<T>::value> atomic(T in){
